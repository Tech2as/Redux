      ...
      <div className={styles.container}>
        ...
        <main className={styles.content}>
          <div className={styles.message}>
           ...
           {//se tiver um user e um user.address
              user && user.address &&(
                <>
            ...
            <button className={styles.btnuser} onClick={handleFetchUsers}>Buscar usuários</button>
            <br/>
            {loading && <strong>Carregando usuários...</strong>}
            
            {!loading && users.map( (user) => (
              <div className={styles.divuser} key={user.id}>
                <p className={styles.puser}>ID: {user.id} | {user.name} | {user.email}</p>
              </div>
            ))}
          </div>
